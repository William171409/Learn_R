...
In conclusion, the results are consistent with theoretical expectations. As $N$ increases, the optimal split approaches $\frac{N}{e}$ (approximately 37% of $N$ candidates), and the probability of selecting the best candidate drifts around $\frac{1}{e}$ (approximately 37%).

While the simulation results did not strictly converge to theoretical results, they are very close and align with the theoretical behavior.
